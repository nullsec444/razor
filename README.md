...
[![Zero-Cost](https://img.shields.io/badge/cost-0%24-success.svg)](https://github.com/nullsec444/stealth-core)
[![Status](https://img.shields.io/badge/anti--detect-100%25_pass-emerald.svg)](https://github.com/nullsec444/stealth-core)
...
```bash
curl -fsSL https://raw.githubusercontent.com/nullsec444/stealth-core/main/scripts/setup.sh | bash
```
...
from stealth_core.tls_client import TLSClient, TLSProfile
...
```python
import asyncio
from stealth_core.tls_client import AsyncTLSClient, TLSProfile
...
```python
from stealth_core.browser import CamoufoxBrowser, BrowserProfileConfig
